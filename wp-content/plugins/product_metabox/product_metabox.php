...
/*
 Khai báo meta box
**/
function product_post_type_meta_box()
{
 add_meta_box( 'thong-tin', 'Thông tin ứng dụng', 'thachpham_thongtin_output', 'product' );
}
add_action( 'add_meta_boxes', 'product_post_type_meta_box' );

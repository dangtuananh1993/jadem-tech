...
if( !function_exists( 'create_product_post_type' )) {
...
if( !function_exists( 'create_category_taxonomy' ) ) {
...
if( !function_exists( 'create_brand_taxonomy' ) ) {
...
if( !function_exists( 'create_tag_taxonomy' ) ) {
 ...
 */
if( !isset( $sale_role ) ) {
	$sale_role = add_role( 'sale', 'Sales', array(
